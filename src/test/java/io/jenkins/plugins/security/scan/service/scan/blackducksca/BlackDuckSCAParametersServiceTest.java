...
public class BlackDuckSCAParametersServiceTest {
    ...
    void validateBlackDuckParametersForValidParametersTest() {
        ...
        assertTrue(blackDuckSCAParametersService.isValidBlackDuckSCAParameters(blackDuckScaParametersMap));
    }
    ...
    void validateBlackDuckParametersForMissingParametersTest() {
        ...
        assertFalse(blackDuckSCAParametersService.isValidBlackDuckSCAParameters(blackDuckScaParametersMap));
    }

    @Test
    void validateBlackDuckParametersForNullAndEmptyTest() {
        assertFalse(blackDuckSCAParametersService.isValidBlackDuckSCAParameters(null));
