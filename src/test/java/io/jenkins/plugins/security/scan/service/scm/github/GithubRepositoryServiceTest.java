...
public class GithubRepositoryServiceTest {
    ...
    void createGithubObjectTest() throws PluginExceptionHandler {
        ...
        Assertions.assertEquals(githubCloud.getRepository().getPull().getNumber(), TEST_REPOSITORY_PULL_NUMBER);
        Assertions.assertEquals(githubCloud.getRepository().getBranch().getName(), TEST_REPOSITORY_BRANCH_NAME);
        ...
        Assertions.assertEquals(githubEnterprise.getRepository().getPull().getNumber(), TEST_REPOSITORY_PULL_NUMBER);
        Assertions.assertEquals(githubEnterprise.getRepository().getBranch().getName(), TEST_REPOSITORY_BRANCH_NAME);
